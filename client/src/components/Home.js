  ...
  render() {
    ...
    return (
      <div>
        ...
        <p className="text-info hometxt"> We are a Toronto, CANADA based group of developers looking to use technology to improve student life! We have a variety of experiences including lowlevel development, android dev, web development, etc that make us a capable group. Our team includes: Sonia Zaldana (developer), Abdullah Sumsum (developer), Marco Angeli (developer) and Ignas Panero Armoska (developer). Catch us around campus!</p>
